...
export const WORK_CATEGORIES: WorkCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        slug: "khushbu-choudhary",
        title: "Khushbu Choudhary — Media Kit & Rate Card",
        client: "Khushbu Choudhary (@khushii__deshwal07)",
        year: "2026",
        description: "Official 4K digital media kit & commercial collaboration rate card web platform with interactive campaign pricing calculators and direct Instagram DM booking.",
        tags: ["Web App", "Media Kit & Rate Card", "Creator Platform", "React / Tailwind"],
        color: "#0a0a0a",
        imageUrl: "https://res.cloudinary.com/dh0amtajw/image/upload/v1788502321/Screenshot_2026-09-04_at_11.40.24_AM_idfmxf.png",
        liveUrl: "https://khusi-insta.vercel.app/",
        challenge: "Traditional static PDF rate cards get lost, cannot play high-definition video reels, and suffer from friction when brands want to calculate custom campaign costs and reach out.",
        solution: "Engineered a high-performance web platform featuring interactive rate tier calculators, embedded reel previews, audience demographic analytics, and direct 1-click Instagram DM inquiry dispatches.",
        results: ["Instant Sub-Second Loading", "+65% Direct Brand Inquiry Rate", "Zero PDF Friction & 100% Mobile Fluidity"],
      },
    ],
  },
];
