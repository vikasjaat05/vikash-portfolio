...
const contentSecurityPolicy = [
  ...
  "form-action 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://www.youtube.com https://s.ytimg.com https://unpkg.com",
  ...
  "connect-src 'self' https://www.youtube.com https://unpkg.com https://lottie.host",
